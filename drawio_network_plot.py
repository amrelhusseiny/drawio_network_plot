...
class NetPlot():
    ...
    def _getMXgraphShape(self,nodeType):
        if nodeType == 'router':
            return {'style':'shape=mxgraph.cisco19.rect;prIcon=router;fillColor=#FAFAFA;strokeColor=#005073;','width':'50','height':'50'}
        elif nodeType == 'l2_switch':
            return {'style':'shape=mxgraph.cisco19.rect;prIcon=l2_switch;fillColor=#FAFAFA;strokeColor=#005073;','width':'50','height':'50'}
        elif nodeType == 'l3_switch':
            return {'style':'shape=mxgraph.cisco19.rect;prIcon=l3_switch;fillColor=#FAFAFA;strokeColor=#005073;','width':'50','height':'50'}
        elif nodeType == 'firewall':
            return {'style':'shape=mxgraph.cisco19.rect;prIcon=firewall;fillColor=#FAFAFA;strokeColor=#005073;','width':'64','height':'50'}
        elif nodeType == 'server':
            return {'style':'shape=mxgraph.cisco19.server;prIcon=;fillColor=#005073;strokeColor=none;','width':'27','height':'50'}
